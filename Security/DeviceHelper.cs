...
namespace Nistec.Web.Security
{
    public class DeviceHelper
    {
        ...
        public static bool IsMobile(System.Web.HttpContextBase context)
        {
            if (context == null || context.Request == null)
                return false;
             string u = context.Request.UserAgent;//.ServerVariables["HTTP_USER_AGENT"];
        ...
        public static bool IsMobile(System.Web.HttpRequestBase Request)
        {
        ...
        public string GetDeviceName(System.Web.HttpRequest Request)
        {
            if (_deviceName != null)
                return _deviceName;
